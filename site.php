...
$app->get("/checkout", function(){
	...
	if (!isset($_GET['zipcode'])) {//comentar se der problema 
...
$app->get("/logout", function(){
    ...
    session_regenerate_id(); //voltar depois
...
$app->get("/forgot", function(){ //tela do esqueceu a senha
...
$app->post("/forgot", function(){//recebe o email de mudança
...
$app->get("/forgot/sent", function() {//tela envio do email de mudança
...
$app->get("/forgot/reset", function(){//tela de mudança de senha
...
$app->post("/forgot/reset", function(){//tela de mudança de senha - para validar a mudança de senha
...
$app->post("/profile/change-password", function(){
	...
	if(!password_verify($_POST['current_pass'], $user->getdespassword())){// se a senha antiga digitada nao estiver correta

		User::setError("A senha atual esta incorreta.");
	...
	$user->setdespassword(User::getPasswordHash($_POST['new_pass']));//como o metodo update nao faz o hash da senha o metodo estatico getPasswordHash faz antes
