...
<html lang="pt-br">
  <head>
    ...
    <!-- Bootstrap -->
    <link rel="stylesheet" href="/res/site/css/bootstrap.min.css"><!-- Mudar para o novo caminho            ANTIGO = css/         NOVO = res/site/css/  -->
                ...
                <div class="col-md-8">
                    <div class="user-menu">
                        <ul>
                            ...
                            <li><a href="/profile"><i class="fa fa-user"></i>  <?php echo getUserName(); ?></a>
                            <li><a href="/logout"><i class="fa fa-close"></i> Sair</a>
                            <?php }else{ ?>
