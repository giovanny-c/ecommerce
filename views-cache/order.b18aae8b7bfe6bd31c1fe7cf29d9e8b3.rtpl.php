...
<div class="content-wrapper">
    ...
    <section class="invoice">
        ...
        <div class="row invoice-info">
            ...
            <b>Status:</b> <?php echo htmlspecialchars( $order["desstatus"], ENT_COMPAT, 'UTF-8', FALSE ); ?><br>
            <b>Pago em:</b> fazer um sistema de reconhecimento de pagamento que mude a o status do pagamento automaticamente assim como insira a data do pagamento
            </div>
            <!-- /.col -->
        </div>
        <!-- /.row -->
