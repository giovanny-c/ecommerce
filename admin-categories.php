...
$app->get("/admin/categories", function(){ //lista todas as categorias para o admin
	...
	if ($search != ''){
		...
		$pagination = Category::getPageSearch($search, $page );//metodo statico para listar os usuarios

	}else{

		$pagination = Category::getPage($page);//metodo statico para listar os usuarios
